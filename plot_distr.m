...
f = waitbar(0,'The plot is excuting!');
...
waitbar(0.2,f);
fid1 = fopen(strcat(rode1,'data1.txt'),'w');   
fid2 = fopen(strcat(rode1,'data2.txt','w');    
fid3 = fopen(strcat(rode1,'data3.txt','w');    
fid4 = fopen(strcat(rode1,'data4.txt','w');    
fid5 = fopen(strcat(rode1,'data5.txt','w');  
...
fprintf(fid,'    echo S 0.3i f0.5+t+l 0.4i/0.3c 2/138/210 2.0p,red  0.7i datum point>legend.dat');
fprintf(fid,'    echo S 0.3i - 0.5i 2/138/210 1.0p,blue 0.7i basic point>>legend.dat');
fprintf(fid,'    echo S 0.3i - 0.44i - 1.p,green, -0.7i leading point>>legend.dat');
fprintf(fid,'    echo S 0.3i - 0.50i yellow 1.0p,yellow 0. 7i island point>>legend.dat');
fprintf(fid,'    echo S 0.3i - 0.50i black 1.0p,black 0. 7i Short baseline>>legend.dat');
